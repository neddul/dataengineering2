...
instance = nova.servers.create(name="lw_3_extraworker_"+str(identifier), image=image, flavor=flavor, key_name='lw_desktop',userdata=userdata, nics=nics,security_groups=secgroups)
